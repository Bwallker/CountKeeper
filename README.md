...
4. Add the submodule that contains all the data files (git submodule add -f https://github.com/CountKeeper/CountKeeperData.git) or 
5. (git submodule add -f git@github.com:CountKeeper/CountKeeperData.git)
6. Create a venv using python3 -m venv /CountKeeperVenv
